    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <p class="section-title bg-white text-center text-primary px-3">會員登入</p>
                <h1 class="mb-5">請登入會員，如無請註冊</h1>
            </div>
            <div class="row g-12" style="display: flex; justify-content: center; align-content: center;flex-wrap: wrap;">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <h3 class="mb-4">請輸入帳號密碼</h3>
                        ...
                        <div  class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    ...
                                    <label for="password">密碼</label><i id="checkEye" class="fas fa-eye"></i>
                                </div>
                            </div>
                            <div class="col-6">
                                <button class="btn btn-secondary rounded-pill py-2 px-2" type="submit">登入</button>
                            </div>
                            <div class="col-6">
                                <button class="btn btn-warning  rounded-pill py-2 px-2 float-end"><a href="Register.html">註冊</button>
                            </div>
                        </div>
                    </form>
                </div>
